...
![alt text](assets/前端面试题/Snipaste_2025-12-03_11-22-19.png)
...
## 28 实现60s倒计时,实现60s倒计时的组件， 有两个按钮，开启，暂停，实现功能。 最后封装为一个自定义hooks